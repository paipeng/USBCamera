...
public class AndroidBmpUtil {
    private static final String TAG = AndroidBmpUtil.class.getSimpleName();
     ...
     * @param orgBitmap
     * @return byte data array of bmp
     */
    public byte[] convertBytes(Bitmap orgBitmap){
        if(orgBitmap == null){
            return null;
        }
        Log.d(TAG, "convertBytes: " + orgBitmap.getWidth() + "-" + orgBitmap.getHeight());
        //image size
